    ...
    <div className="md:h-screen">
      ...
      <div className="grid grid-cols-2 dark:text-white p-3 gap-1.5">
        <div className="grid col-span-1 pl-3" key={game.id}>
          <h1 className="text-2xl md:text-4xl font-bold mb-3 p-2">{game.name}</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 mt-8 p-2 pl-2">
            <div className="grid col-span-1">
            <h2 className="font-bold text-xl md:text-2xl">Platform</h2>
            {game.parent_platforms.map((platform, index) => (
              <p className="text-lg pl-2" key={index}>{platform.platform.name}</p>
            ))}
            <h2 className="font-bold text-xl md:text-2xl">Metacritic</h2>
            <p className="text-lg pl-2">{game.metacritic}</p>
            <h2 className="font-bold text-xl md:text-2xl">Released Date </h2>
              <p className="text-lg pl-2">{game.released}</p>
          </div>
          <div className="grid col-span-1">
            <h2 className="font-bold text-xl md:text-2xl">Rating</h2>
            <p className="text-lg pl-2">{game.rating}</p>
            <h2 className="font-bold text-xl md:text-2xl">Genre</h2>
            {game.genres.map((genre, index) => (
              <p className="text-lg pl-2" key={index}>{genre.name}</p>
            ))}
            <h2 className="font-bold text-xl md:text-2xl">Publisher</h2>
