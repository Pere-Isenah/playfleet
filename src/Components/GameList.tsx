    ...
    <div className="p-4">
      ...
      <div className="grid gap-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {selectedGenre.map((item) => (
          <div key={item.id} className="bg-slate-300 p-3 pb-9 h-full rounded-lg hover:scale-110 transition-all duration-300 cursor-pointer dark:bg-gray-700">
            <img className="w-full h-[80%] rounded-xl object-cover" src={item.background_image} alt={item.name} width={1080} />
